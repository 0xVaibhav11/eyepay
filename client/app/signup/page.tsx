...
export default function LoginWithWorldcoin() {
  ...
  ///UID = 0x4c9f6cab42e08cc1c22465ea349974b46d99ae74e5b032014672f57c23bb3ebd
  const eas = new EAS("0x4200000000000000000000000000000000000021");
  async function EASuse(real: string, useraddress: string) {
    // eas.connect();

    // Initialize SchemaEncoder with the schema string
    const schemaEncoder = new SchemaEncoder("string realId, address ownerAddr");
    const encodedData = schemaEncoder.encodeData([
      { name: "realId", value: 1, type: "string" },
      { name: "ownerAddr", value: 1, type: "address" },
    ]);

    const schemaUID =
      "0x6f70e401ea834987b36965080dbb69f95589d48fdcf1a16c4ec8aa9c154eff76";
